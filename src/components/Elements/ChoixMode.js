export default function ChoixMode(props) {
  ...
  return (
    <div className="join mb-5">
      ...
      <input onClick={onSelectHandler} className="join-item btn btn-square w-fit px-4" type="radio" name="choixMode" value="4" aria-label="Amérique" defaultChecked={props.modeSelect==="4"} />
      <input onClick={onSelectHandler} className="join-item btn btn-square w-fit px-4" type="radio" name="choixMode" value="5" aria-label="Océanie" defaultChecked={props.modeSelect==="5"} />
